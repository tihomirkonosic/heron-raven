...
int main(int argc, char **argv) {
  ...
  if (!param.skip_contruction){
    ...
    graph_constructor.Construct(sequences, param.disagreement, param.split, param.kMaxNumOverlaps, param.ploidy, param.kmer_len, param.window_len, param.bandwidth, param.chain_n, param.match_n, param.gap_size, param.freq, param.hpc, param.paf, param.valid_region_size);
  } else {
