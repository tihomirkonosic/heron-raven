...
int main(int argc, char **argv) {
	...
	graph_constructor.Construct(sequences, disagreement, split, kMaxNumOverlaps, kmer_len, window_len, freq,
								valid_region_size);
	...
	graph_polisher.Polish(sequences, m, n, g, cuda_poa_batches, cuda_banded_alignment, cuda_alignment_batches, num_polishing_rounds);
