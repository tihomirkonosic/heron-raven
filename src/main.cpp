...
int main(int argc, char **argv) {
  ...
  if (!param.skip_contruction){
    graph_constructor.Construct(sequences, param.disagreement, param.split, param.max_overlaps, param.ploidy, param.kmer_len, 
                                param.window_len, param.bandwidth, param.chain_n, param.match_n, param.gap_size, param.freq, 
                                param.hpc, param.paf, param.valid_region_length, param.valid_region_coverage, param.herro_snps, param.load_paf);
  } else {
